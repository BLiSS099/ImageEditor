...
side_frame_addfilter = tk.Button(top_right_frame, text="Blur", relief="raised", padx=10, command=blur)
side_frame_addfilter.grid(row=2, column=1, padx=5, pady=10)
noise_btn = tk.Button(top_right_frame, text="Noise", relief="raised", padx=10, command=noise)
noise_btn.grid(row=2, column=2, padx=5, pady=10)
charcoal_btn = tk.Button(top_right_frame, text="Charcoal", relief="raised", padx=10, command=charcoal)
